...
public final class Position {
	...
	public boolean inMulti() {
		if (Boundary.isIn(this, Boundary.ZULRAH)
				...
				|| Boundary.isIn(this, Boundary.DIAMOND_ZONE)
				|| Boundary.isIn(this, Boundary.SEREN_ROOM)
				|| Boundary.isIn(this, Boundary.NEW_WILDY_DUNGEON)
				|| Boundary.isIn(this, Boundary.CORPOREAL_BEAST_LAIR)
				|| Boundary.isIn(this, Boundary.ABOMINATION)
				...
				|| Boundary.isIn(this, Boundary.AVATAR_OF_DESTRUCTION)
				|| Boundary.isIn(this, Boundary.UMOONZONE)
				|| Boundary.isIn(this, Boundary.JELLY_ROOM)
				|| Boundary.isIn(this, Boundary.INADEQUACY)
				|| Boundary.isIn(this, Boundary.WILDY_SLAYER_CAVE)
				|| Boundary.isIn(this, Boundary.BANDIT_TWO)
