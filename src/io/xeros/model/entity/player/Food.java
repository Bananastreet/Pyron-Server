...
public class Food {
    ...
    public boolean torvaHelm(Player player) {
        if (player.getItems().isWearingItem(26382) || player.getItems().isWearingItem(29057) || player.getItems().isWearingItem(29060) || player.getItems().isWearingItem(29063) || player.getItems().isWearingItem(29066)) {
            return true;
        }
        return false;
    }
    ...
    public boolean torvaBody(Player player) {
        if (player.getItems().isWearingItem(26384) || player.getItems().isWearingItem(29058) || player.getItems().isWearingItem(29061) || player.getItems().isWearingItem(29064) || player.getItems().isWearingItem(29067)) {
            return true;
        }
        return false;
    }
    ...
    public boolean torvaLegs(Player player) {
        if (player.getItems().isWearingItem(26386) || player.getItems().isWearingItem(29059) || player.getItems().isWearingItem(29062) || player.getItems().isWearingItem(29065) || player.getItems().isWearingItem(29068)) {
            return true;
        }
        return false;
    }
    ...
    public void eat(int id, int slot) {
        ...
        if (torvaHelm(player) && torvaBody(player) && torvaLegs(player)) {
            player.getHealth().setMaximumHealth((int) (player.getPA().getLevelForXP(player.playerXP[Player.playerHitpoints]) * 1.40));
        }
