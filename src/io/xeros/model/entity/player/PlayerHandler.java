...
public class PlayerHandler {
	...
	//Used for player messages, ie: drops, 99 announcements, pet announcements, etc
	public static void dropMessage(String message) {
		executeGlobalMessage("<img=35><col=9E4A00>News: " + message);
	}

	//Used for server messages, ie: events, well of goodwill, etc
	public static void newsMessage(String message) {
		executeGlobalMessage("<img=36><col=02670C>News: " + message);
	}
