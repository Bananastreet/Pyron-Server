...
public enum Right implements Comparator<Right> {
	...
	UNKNOWN(4, "F5FF0F"),
	SAPPHIRE_DONATOR(5, "1B1ABC"),
	EMERALD_DONATOR(7, "118120", SAPPHIRE_DONATOR),
	RUBY_DONATOR(9, "6D0000", EMERALD_DONATOR),
	DIAMOND_DONATOR(17, "005C6D", RUBY_DONATOR),
	ONYX_DONATOR(18, "4a4a4a", DIAMOND_DONATOR),
	...
	public static final EnumSet[] DISPLAY_GROUPS = {
			EnumSet.of(HELPER, MODERATOR, ADMINISTRATOR, OWNER, UNKNOWN, SAPPHIRE_DONATOR, EMERALD_DONATOR,
					RUBY_DONATOR, DIAMOND_DONATOR, ONYX_DONATOR, YOUTUBER),
	 ...
	 * Donator rights.
	 */
	public static final EnumSet<Right> DONATOR_SET = EnumSet.of(SAPPHIRE_DONATOR, EMERALD_DONATOR, RUBY_DONATOR, DIAMOND_DONATOR, ONYX_DONATOR);
	 ...
	 * </p>
	 */
	public static final Right[] PRIORITY = { PLAYER, OSRS, EVENT_MAN, HC_IRONMAN, GROUP_IRONMAN, IRONMAN, ULTIMATE_IRONMAN, MEMBERSHIP, SAPPHIRE_DONATOR, EMERALD_DONATOR, RUBY_DONATOR, DIAMOND_DONATOR, ONYX_DONATOR,YOUTUBER, HITBOX, HELPER,
