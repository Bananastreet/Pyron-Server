...
public class Walking implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		if (!(c.getSuperMysteryBox().canMysteryBox) || !(c.getNormalMysteryBox().canMysteryBox) || !(c.getGodwarsMysteryBox().canMysteryBox) || !(c.getUltraMysteryBox().canMysteryBox) || !(c.getPVPMysteryBox().canMysteryBox) || !(c.getRaresMysteryBox().canMysteryBox) || !(c.getFoeMysteryBox().canMysteryBox) || !(c.getPetMysteryBox().canMysteryBox) || !(c.getYoutubeMysteryBox().canMysteryBox)) {
