...
//						break;
                    ...
                    case 30720:
                        c.objectDistance = 3;
                        if (c.getItems().playerHasItem(Items.CHEST_KEY)) {
                            ChestKeyLooting.lootChest(c);
                        } else if (c.getItems().playerHasItem(Items.WILDERNESS_KEY)) {
                            new WildernessKey().roll(c);
                        } else {
                            c.getDH().sendStatement("You need a chest key or wilderness key to open this chest.");
                        }
                    ...
                    case 28686:
                        ...
                        break;
                    case 26738:
                        c.getPA().movePlayer(new Coordinate(3112, 3508));
