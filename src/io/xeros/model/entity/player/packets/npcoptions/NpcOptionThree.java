...
//           break;
			case 9120:
				player.getPA().sendFrame126("https://vanguardrsps.com/forums/showthread.php?tid=25&pid=25#pid25", 12000);
				player.sendMessage("@red@Attempting to open forum thread #25 in your browser...");
				break;
		case 8781:
