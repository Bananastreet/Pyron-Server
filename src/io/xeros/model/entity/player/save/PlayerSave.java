...
import io.xeros.model.PermanentAttributes.AttributeKey;
import io.xeros.model.PermanentAttributes.PermanentAttributeKeyManager;
...
public class PlayerSave {
                        ...
                        case 2:
                            ...
                            if (attributeForToken != null) {
                                try {
                                    ...
                                    if (decoded != null) {
                                        p.getPermAttributes().put(attributeForToken, decoded);
                                    }
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            ...
                            if (token.equals("character-height")) {
                            ...
                            } else if (token.equals("battlepass-level")) {
                                p.battlepassLevel = Integer.parseInt(token2);
                            } else if (token.equals("battlepass-xp")) {
                                p.battlepassExperience = Integer.parseInt(token2);
                            ...
                            } else if (token.equals("extraBankSpace")) {
                                p.extraBankSpace = (Integer.parseInt(token2));
                            ...
                            } else if (token.equals("mysteryBoxes")) {
                                p.mysteryBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("superBoxes")) {
                                p.superBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("ultraBoxes")) {
                                p.ultraBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("pvpBoxes")) {
                                p.pvpBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("raresBoxes")) {
                                p.raresBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("masterBoxes")) {
                                p.masterBoxes = (Integer.parseInt(token2));
                            } else if (token.equals("godwarsBoxes")) {
                                p.godwarsBoxes = (Integer.parseInt(token2));
                            ...
                            } else if (token.equals("dropScrollTicks")) {
                                p.dropScrollTicks = Long.parseLong(token2);
                            } else if (token.equals("seasonalScrollTicks")) {
                                p.seasonalScrollTicks = Long.parseLong(token2);
                            } else if (token.equals("damageScrollTicks")) {
                                p.damageScrollTicks = Long.parseLong(token2);
                            } else if (token.equals("coxScrollTicks")) {
                                p.coxScrollTicks = Long.parseLong(token2);
                            } else if (token.equals("fiftyDamageScrollTicks")) {
                                p.fiftyDamageScrollTicks = Long.parseLong(token2);
                            } else if (token.equals("tomeOfExperienceTicks")) {
                                p.tomeOfExperienceTicks = Long.parseLong(token2);
                            } else if (token.equals("tomeOfPetsTicks")) {
                                p.tomeOfPetsTicks = Long.parseLong(token2);
                            } else if (token.equals("doubleDropScrollTicks")) {
                                p.doubleDropScrollTicks = Long.parseLong(token2);
                            ...
                            } else if (token.equals("dropScrollActive")) {
                                p.dropScrollActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("seasonalScrollActive")) {
                                p.seasonalScrollActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("damageScrollActive")) {
                                p.damageScrollActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("coxScrollActive")) {
                                p.coxScrollActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("fiftyDamageScrollActive")) {
                                p.fiftyDamageScrollActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("tomeOfExperienceActive")) {
                                p.tomeOfExperienceActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("tomeOfPetsActive")) {
                                p.tomeOfPetsActive = Boolean.parseBoolean(token2);
                            } else if (token.equals("doubleDropScrollActive")) {
                                p.doubleDropScrollActive = Boolean.parseBoolean(token2);
                                ...
                                p.tokensSpent = Integer.parseInt(token2);
                            } else if (token.equals("bc1")) {
                                p.bc1 = Integer.parseInt(token2);
                            } else if (token.equals("bc2")) {
                                p.bc2 = Integer.parseInt(token2);
                            } else if (token.equals("bc3")) {
                                p.bc3 = Integer.parseInt(token2);
                            } else if (token.equals("bc4")) {
                                p.bc4 = Integer.parseInt(token2);
                            } else if (token.equals("bc5")) {
                                p.bc5 = Integer.parseInt(token2);
                            } else if (token.equals("bc1Amount")) {
                                p.bc1Amount = Integer.parseInt(token2);
                            } else if (token.equals("bc2Amount")) {
                                p.bc2Amount = Integer.parseInt(token2);
                            } else if (token.equals("bc3Amount")) {
                                p.bc3Amount = Integer.parseInt(token2);
                            } else if (token.equals("bc4Amount")) {
                                p.bc4Amount = Integer.parseInt(token2);
                            } else if (token.equals("bc5Amount")) {
                                p.bc5Amount = Integer.parseInt(token2);
                            } else if (token.equals("totalBC")) {
                                p.totalBC = Integer.parseInt(token2);
                            ...
                            } else if (token.equals("chestsOpened")) {
                                p.treasureChests = Integer.parseInt(token2);
                            ...
                            } else if (token.equals("claimed-premium-levels")) {
                                for (int index = 0; index < token3.length; index++) {
                                    try {
                                        int claimedLevel = Integer.parseInt(token3[index]);
                                        if (!p.getClaimedPremiumLevels().contains(claimedLevel)) {
                                            p.getClaimedPremiumLevels().add(claimedLevel);
                                        }
                                    } catch (NumberFormatException e) {
                                        logger.error("Error while loading claimed premium levels for {}", playerName, e);
                                        e.printStackTrace();
                                    }
                                }
                            } else if (token.equals("claimed-free-levels")) {
                                for (int index = 0; index < token3.length; index++) {
                                    try {
                                        int claimedLevel = Integer.parseInt(token3[index]);
                                        if (!p.getClaimedFreeLevels().contains(claimedLevel)) {
                                            p.getClaimedFreeLevels().add(claimedLevel);
                                        }
                                    } catch (NumberFormatException e) {
                                        logger.error("Error while loading claimed premium levels for {}", playerName, e);
                                        e.printStackTrace();
                            ...
                            } else if (token.equals("unclaimed-items")) {
                                for (int index = 0; index < token3.length; index++) {
                                    try {
                                        String[] itemInfo = token3[index].split(":");
                                        if (itemInfo.length == 2) {
                                            int itemId = Integer.parseInt(itemInfo[0]);
                                            int amount = Integer.parseInt(itemInfo[1]);
                                            GameItem item = new GameItem(itemId, amount); // Assuming a constructor like (id, amount) is available
                                            p.getUnclaimedItems().add(item);
                                        } else {
                                            // Handle incorrect format or missing data in the file
                                        }
                                    } catch (NumberFormatException | ArrayIndexOutOfBoundsException e) {
                                        logger.error("Error while loading unclaimed items for {}", playerName, e);
                                        e.printStackTrace();
                                    }
                                }
                            ...
                            } else if (token.equals("premium-battlepass")) {
                                p.premiumBattlepass = Boolean.parseBoolean(token2);
    ...
    public static boolean saveGameInstant(Player p) {
        ...
        try {
            ...
            characterfile.newLine();
            characterfile.write("battlepass-level = " + p.battlepassLevel);
            characterfile.newLine();
            characterfile.write("battlepass-xp = " + p.battlepassExperience);
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("extraBankSpace = " + p.extraBankSpace);
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("totalPrestiges = " + p.totalPrestiges);
            characterfile.newLine();
            characterfile.write("mysteryBoxes = " + p.mysteryBoxes);
            characterfile.newLine();
            characterfile.write("superBoxes = " + p.superBoxes);
            characterfile.newLine();
            characterfile.write("ultraBoxes = " + p.ultraBoxes);
            characterfile.newLine();
            characterfile.write("masterBoxes = " + p.masterBoxes);
            characterfile.newLine();
            characterfile.write("godwarsBoxes = " + p.godwarsBoxes);
            characterfile.newLine();
            characterfile.write("pvpBoxes = " + p.pvpBoxes);
            characterfile.newLine();
            characterfile.write("raresBoxes = " + p.raresBoxes);
            characterfile.newLine();
            ...
            characterfile.newLine();
            List<Integer> claimedPremiumLevels = p.getClaimedPremiumLevels();
            if (!claimedPremiumLevels.isEmpty()) {
                characterfile.write("claimed-premium-levels = ");
                for (int index = 0; index < claimedPremiumLevels.size(); index++) {
                    characterfile.write(claimedPremiumLevels.get(index).toString());
                    if (index < claimedPremiumLevels.size() - 1) {
                        characterfile.write("\t");
                    }
                }
            }
            characterfile.newLine();
            List<Integer> claimedFreeLevels = p.getClaimedFreeLevels();
            if (!claimedFreeLevels.isEmpty()) {
                characterfile.write("claimed-free-levels = ");
                for (int index = 0; index < claimedFreeLevels.size(); index++) {
                    characterfile.write(claimedFreeLevels.get(index).toString());
                    if (index < claimedFreeLevels.size() - 1) {
                        characterfile.write("\t");
                    }
                }
            }
            characterfile.newLine();
            List<GameItem> unclaimedItems = p.getUnclaimedItems();
            if (!unclaimedItems.isEmpty()) {
                characterfile.write("unclaimed-items = ");
                for (int index = 0; index < unclaimedItems.size(); index++) {
                    GameItem item = unclaimedItems.get(index);
                    characterfile.write(item.getId() + ":" + item.getAmount()); // Assuming getId() returns item ID and getAmount() returns its amount
                    if (index < unclaimedItems.size() - 1) {
                        characterfile.write("\t");
                    }
                }
            }
            ...
            characterfile.newLine();
            characterfile.write("seasonalScrollActive = ");
            characterfile.write(Boolean.toString(p.seasonalScrollActive));
            characterfile.newLine();
            characterfile.write("seasonalScrollTicks = ");
            characterfile.write(Long.toString(p.seasonalScrollTicks));
            characterfile.newLine();
            characterfile.write("dropScrollActive = ");
            characterfile.write(Boolean.toString(p.dropScrollActive));
            characterfile.newLine();
            characterfile.write("dropScrollTicks = ");
            characterfile.write(Long.toString(p.dropScrollTicks));
            characterfile.newLine();
            characterfile.write("damageScrollActive = ");
            characterfile.write(Boolean.toString(p.damageScrollActive));
            characterfile.newLine();
            characterfile.write("damageScrollTicks = ");
            characterfile.write(Long.toString(p.damageScrollTicks));
            characterfile.newLine();
            characterfile.write("fiftyDamageScrollActive = ");
            characterfile.write(Boolean.toString(p.fiftyDamageScrollActive));
            characterfile.newLine();
            characterfile.write("fiftyDamageScrollTicks = ");
            characterfile.write(Long.toString(p.fiftyDamageScrollTicks));
            characterfile.newLine();
            characterfile.write("tomeOfExperienceActive = ");
            characterfile.write(Boolean.toString(p.tomeOfExperienceActive));
            characterfile.newLine();
            characterfile.write("tomeOfExperienceTicks = ");
            characterfile.write(Long.toString(p.tomeOfExperienceTicks));
            characterfile.newLine();
            characterfile.write("tomeOfPetsActive = ");
            characterfile.write(Boolean.toString(p.tomeOfPetsActive));
            characterfile.newLine();
            characterfile.write("tomeOfPetsTicks = ");
            characterfile.write(Long.toString(p.tomeOfPetsTicks));
            characterfile.newLine();
            characterfile.write("coxScrollActive = ");
            characterfile.write(Boolean.toString(p.coxScrollActive));
            characterfile.newLine();
            characterfile.write("coxScrollTicks = ");
            characterfile.write(Long.toString(p.coxScrollTicks));
            characterfile.newLine();
            characterfile.write("doubleDropScrollActive = ");
            characterfile.write(Boolean.toString(p.doubleDropScrollActive));
            characterfile.newLine();
            characterfile.write("doubleDropScrollTicks = ");
            characterfile.write(Long.toString(p.doubleDropScrollTicks));
            characterfile.newLine();
            ...
            characterfile.write(Integer.toString(p.tokensSpent), 0, Integer.toString(p.tokensSpent).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("chestsOpened = ", 0, 15);
            characterfile.write(Integer.toString(p.treasureChests), 0, Integer.toString(p.treasureChests).length());
            characterfile.newLine();
            ...
            for (Map.Entry<AttributeKey<?>, Object> entry : p.getPermAttributes().entries()) {
                ...
                if (key.serializationKeyOrNull() != null) {
            ...
            characterfile.newLine();
            characterfile.write("pouch-rune = " + p.getRuneEssencePouch(0) + "\t" + p.getRuneEssencePouch(1) + "\t" + p.getRuneEssencePouch(2) + "\t" + p.getRuneEssencePouch(3));
            characterfile.newLine();
            characterfile.write("pouch-pure = " + p.getPureEssencePouch(0) + "\t" + p.getPureEssencePouch(1) + "\t" + p.getPureEssencePouch(2) + "\t" + p.getPureEssencePouch(3));
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.write("premium-battlepass = ", 0, 21);
            characterfile.write(Boolean.toString(p.premiumBattlepass), 0, Boolean.toString(p.premiumBattlepass).length());
            characterfile.newLine();
            ...
            characterfile.newLine();
            characterfile.newLine();
            characterfile.write("[BOSS CHALLENGES]", 0, 17);
            characterfile.newLine();
            characterfile.write("bc1 = ", 0, 6);
            characterfile.write(Integer.toString(p.bc1), 0, Integer.toString(p.bc1).length());
            characterfile.newLine();
            characterfile.write("bc2 = ", 0, 6);
            characterfile.write(Integer.toString(p.bc2), 0, Integer.toString(p.bc2).length());
            characterfile.newLine();
            characterfile.write("bc3 = ", 0, 6);
            characterfile.write(Integer.toString(p.bc3), 0, Integer.toString(p.bc3).length());
            characterfile.newLine();
            characterfile.write("bc4 = ", 0, 6);
            characterfile.write(Integer.toString(p.bc4), 0, Integer.toString(p.bc4).length());
            characterfile.newLine();
            characterfile.write("bc5 = ", 0, 6);
            characterfile.write(Integer.toString(p.bc5), 0, Integer.toString(p.bc5).length());
            characterfile.newLine();
            characterfile.write("bc1Amount = ", 0, 12);
            characterfile.write(Integer.toString(p.bc1Amount), 0, Integer.toString(p.bc1Amount).length());
            characterfile.newLine();
            characterfile.write("bc2Amount = ", 0, 12);
            characterfile.write(Integer.toString(p.bc2Amount), 0, Integer.toString(p.bc2Amount).length());
            characterfile.newLine();
            characterfile.write("bc3Amount = ", 0, 12);
            characterfile.write(Integer.toString(p.bc3Amount), 0, Integer.toString(p.bc3Amount).length());
            characterfile.newLine();
            characterfile.write("bc4Amount = ", 0, 12);
            characterfile.write(Integer.toString(p.bc4Amount), 0, Integer.toString(p.bc4Amount).length());
            characterfile.newLine();
            characterfile.write("bc5Amount = ", 0, 12);
            characterfile.write(Integer.toString(p.bc5Amount), 0, Integer.toString(p.bc5Amount).length());
            characterfile.newLine();
            characterfile.write("totalBC = ", 0, 10);
            characterfile.write(Integer.toString(p.totalBC), 0, Integer.toString(p.totalBC).length());
            characterfile.newLine();
            characterfile.newLine();
            characterfile.newLine();
