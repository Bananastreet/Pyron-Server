...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 380:
			c.talkingNpc = 8761;
			sendNpcChat ("This cave leads to the Crystalline Hunllef boss.", "@red@[WARNING] You cannot teleport away!", "Bring multiple combat styles.");
			c.nextChat = 369;
			break;
		case 369:
			...
			break;
		case 381:
			sendOption3("Yes, I am ready to fight. @red@[No Escape]", "Yes, and don't show the warning again", "No, I'm scared.");
		...
		case 701:
			...
			if (c.getItems().playerHasItem(13273)) {
				...
				if (Misc.random(100) == 15) {
					...
					PlayerHandler.dropMessage(c.getDisplayNameFormatted() + " received a pet from Abyssal Sire!");
		...
		case 80:
			sendOption2("Upgrade to Elite for 200 points per piece.", "Other Items Shop");
			c.dialogueAction = 80;
			break;
		...
		case 947:
			...
			break;
		case 10955:
			sendNpcChat("I can get you a corrupted task but",
					"it will cost you 2m.");
			c.nextChat = 10956;
			break;
		case 10956:
			sendOption2("I would like a corrupted task for 2m please.","Nevermind");
		...
		case 631:
			sendStatement("Would you like to enter the resource area for 50,000gp?");
			c.nextChat = 632;
			break;
		...
		case 2647:
			sendOption3("Fast Xp Rates","@red@[WARNING] 5x XP Rates but +10% Drop Rate Boost[SLOW]",
