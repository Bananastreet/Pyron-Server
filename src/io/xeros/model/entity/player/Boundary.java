...
public class Boundary {
	...
	public static final Boundary SEASONAL_CAVE = new Boundary(2430, 9409, 2492, 9465);
	...
	public static final Boundary UMOONZONE = new Boundary(3048, 5476, 3070, 5495);
	...
	public static final Boundary OUTLAST_HUT = new Boundary(3110, 3507, 3117, 3512);
	...
	public static final Boundary FLOWER_POKER_AREA = new Boundary(3073, 3455, 3094, 3480);
	public static final Boundary FP_LANE_1 = new Boundary(3076, 3460, 3077, 3464);
	public static final Boundary FP_LANE_2 = new Boundary(3081, 3460, 3082, 3464);
	public static final Boundary FP_LANE_3 = new Boundary(3086, 3460, 3087, 3464);
	public static final Boundary FP_LANE_4 = new Boundary(3091, 3460, 3092, 3464);
	...
	public static final Boundary VOTE_BOSS = new Boundary(3655, 5772, 3694, 5804);

	public static final Boundary Nex = new Boundary(2910,5188,2940,5217);//New nex

	public static final Boundary NEW_WILDY_DUNGEON = new Boundary(3107,10249,3121,10263);//New wildy dungeon, custom boss

	public static final Boundary RUBY_PLUS_ZONE = new Boundary(1215,2680,1280,2795);//ruby+ donator zone

	public static final Boundary AVATAR_OF_DESTRUCTION = new Boundary(2967, 4560, 2989, 4592);

	public static final Boundary JELLY_ROOM = new Boundary(1320, 9955, 1340, 9980);

	public static final Boundary INADEQUACY = new Boundary(1800, 5130, 1845, 5170);

	public static final Boundary BANDIT_TWO = new Boundary(3467, 3080, 3492, 3116);

	public static final Boundary RUBY_VYRE = new Boundary(1241, 2734, 1254, 2751);

	public static final Boundary DIAMOND_ZONE = new Boundary(3777, 3265, 3838, 3326);

	public static final Boundary ONYX_ZONE_NEW = new Boundary(2308, 9796, 2364, 9915);

	public static final Boundary ZENYTE_ZONE = new Boundary(1667, 4227, 1724, 4284);
	/**
	 * 3118 3923
	 * 3128 3942
	 *
...
//3082 3921
	...
	public static final Boundary ABOMINATION = new Boundary(3728, 3957, 3747, 3979);
	...
	public static final Boundary WILDY_SLAYER_CAVE = new Boundary(3322, 10041, 3458, 10177);
	/**
	 * Hunter
	 */
	...
	public static final Boundary SKOTIZO_BOSSROOM = new Boundary(2251, 5643, 2293, 5684);
	...
	public static final Boundary SEREN_ROOM = new Boundary(3154, 5328, 3173, 5347);
	...
	public static final Boundary TARN_AREA = new Boundary(2500, 9280, 2540, 9315);

	public static final Boundary ULFRIC_AREA = new Boundary(3788, 9052, 3885, 9130);
	...
	public static final Boundary[] WILDERNESS_PARAMETERS = {WILDERNESS, WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY, REV_CAVE, WILDY_SLAYER_CAVE};
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary TOB = new Boundary(3126, 4206, 3332, 4488);
