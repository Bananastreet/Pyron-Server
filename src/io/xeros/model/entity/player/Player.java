...
import io.xeros.content.perks.PerkCategories;
...
import io.xeros.content.skills.firemake.BonfireEvent;
...
import io.xeros.content.tiersystem.TierManager;
...
import io.xeros.content.worldevent.events.tournaments.OutlastLeaderboardEntry;
...
import io.xeros.model.PermanentAttributes.PermanentAttributeKeyComponent;
...
public class Player extends Entity {
    ...
    public List<GameItem> getUnclaimedItems() {
        return unclaimedItems;
    }
    public int battlepassPage;

    public boolean premiumBattlepass = false;

    public boolean isOnAfkResource;
    ...
    public static final int customslot1 = 6;
    public static final int customslot2 = 8;
    ...
    public int bc1;
    public int bc1Amount;
    public int bc2;
    public int bc2Amount;
    public int bc3;
    public int bc3Amount;
    public int bc4;
    public int bc4Amount;
    public int bc5;
    public int bc5Amount;
    public int totalBC;
    ...
    public TierManager tierManager = new TierManager(this);

    public LeaderboardManager leaderboardManager = new LeaderboardManager(this);
    ...
    */
    ...
    /**
     * Amount of treasure chests opened
     */
    ...
    public void setTreasureChests(int value) {
    ...
    public int mysteryBoxes;
    public int superBoxes;
    public int ultraBoxes;
    public int masterBoxes;
    public int godwarsBoxes;
    public int pvpBoxes;
    public int raresBoxes;
    ...
    private final PVPMysteryBox PVPMysteryBox = new PVPMysteryBox(this);
    private final GodwarsMysteryBox GodwarsMysteryBox = new GodwarsMysteryBox(this);
    private final RaresMysteryBox RaresMysteryBox = new RaresMysteryBox(this);
    ...
    private final PetMysteryBox petMysteryBox = new PetMysteryBox(this);
    ...
    private final BonfireEvent bonfire = new BonfireEvent(this);
    ...
    public boolean hasPerk(PermanentAttributeKey<?> perk) {
        return (boolean) getPermAttributes().getOrDefault(perk);
    }

    private final PerkHandler perkHandler = new PerkHandler(this);

    public PerkHandler getPerks() {
        return perkHandler;
    }

    private PerkCategories perkCategory = PerkCategories.COMBAT;

    public PerkCategories getPerkCategory() {
        return perkCategory;
    }

    public void setPerkCategory(PerkCategories perkCategory) {
        this.perkCategory = perkCategory;
    }

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> ABYSSAL_WARRIOR = new PermanentAttributeKey<>(false, "abyssal-warrior");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> DEMONIC_DEFILER = new PermanentAttributeKey<>(false, "demonic-defiler");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> SNAKE_CHARMER = new PermanentAttributeKey<>(false, "snake-charmer");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> WILD_PVMER = new PermanentAttributeKey<>(false, "wild-pvmer");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> COX_CRUSHER = new PermanentAttributeKey<>(false, "cox-crusher");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> SEREN_SLAYER = new PermanentAttributeKey<>(false, "seren-slayer");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> NEXUS_WARRIOR = new PermanentAttributeKey<>(false, "nexus-warrior");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> NEXUS_ARCHER = new PermanentAttributeKey<>(false, "nexus-archer");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> NEXUS_MAGICIAN = new PermanentAttributeKey<>(false, "nexus-magician");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> CRYSTAL_RANGER = new PermanentAttributeKey<>(false, "crystal-ranger");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> CORRUPT_RANGER = new PermanentAttributeKey<>(false, "corrupt-ranger");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> THEATRE_PERFORMER = new PermanentAttributeKey<>(false, "theatre-performer");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BARROWS_BASHER = new PermanentAttributeKey<>(false, "barrows-basher");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> NASTY_NEX = new PermanentAttributeKey<>(false, "nasty-nex");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> RING_OF_WEALTHIER = new PermanentAttributeKey<>(false, "ring-of-wealthier");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> GRIND_HATER = new PermanentAttributeKey<>(false, "grind-hater");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> TOURNY_BOOSTER = new PermanentAttributeKey<>(false, "tourny-booster");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> SLAYER_BOOSTER = new PermanentAttributeKey<>(false, "slayer-booster");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BLOOD_STEALER = new PermanentAttributeKey<>(false, "blood-stealer");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> COX_BOOSTER = new PermanentAttributeKey<>(false, "cox-booster");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> PEST_CONTROLLER = new PermanentAttributeKey<>(false, "pest-controller");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> UPGRADED_RAID = new PermanentAttributeKey<>(false, "upgraded-raid");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> PERKY_JERKY = new PermanentAttributeKey<>(false, "perky-jerky");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> PET_CEMETARY = new PermanentAttributeKey<>(false, "pet-cemetary");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BOSS_BOOST = new PermanentAttributeKey<>(false, "boss-boost");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> EXCHANGE_MASTER = new PermanentAttributeKey<>(false, "exchange-master");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BOSS_CHALLENGER = new PermanentAttributeKey<>(false, "boss-challenger");
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> CHEST_HUNTER = new PermanentAttributeKey<>(false, "chest-hunter");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> RAW_COLLECTOR = new PermanentAttributeKey<>(false, "raw-collector");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> HUNLLEF_DOUBLER = new PermanentAttributeKey<>(false, "hunllef-doubler");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> MASTER_CHEF = new PermanentAttributeKey<>(false, "master-chef");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> MIGHTY_MINER = new PermanentAttributeKey<>(false, "mighty-miner");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> CRYSTAL_COLLECTOR = new PermanentAttributeKey<>(false, "crystal-collector");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> COIN_COLLECTOR = new PermanentAttributeKey<>(false, "coin-collector");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> RESOURCE_COLLECTOR = new PermanentAttributeKey<>(false, "resource-collector");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> PYRO_LUMBERJACK = new PermanentAttributeKey<>(false, "pyro-lumberjack");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> MASTER_SMITHER = new PermanentAttributeKey<>(false, "master-smither");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> POCKET_CRUSHER = new PermanentAttributeKey<>(false, "pocket-crusher");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> HERB_STACKER = new PermanentAttributeKey<>(false, "herb-stacker");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> OVERLOADED = new PermanentAttributeKey<>(false, "overloaded");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> LONG_OVERLOADED = new PermanentAttributeKey<>(false, "long-overloaded");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> PRO_SALESMAN = new PermanentAttributeKey<>(false, "pro-salesman");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> THE_ACCUMULATOR = new PermanentAttributeKey<>(false, "the-accumulator");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BANK_HOARDER = new PermanentAttributeKey<>(false, "bank-hoarder");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> GOT_THE_BAG = new PermanentAttributeKey<>(false, "got-the-bag");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> MEGA_RESTORE = new PermanentAttributeKey<>(false, "MEGA_RESTORE");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> SEASONAL_PICKUP = new PermanentAttributeKey<>(false, "seasonal-pickup");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> ARCANE_MAGE = new PermanentAttributeKey<>(false, "arcane-mage");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BULWARK_BUILD = new PermanentAttributeKey<>(false, "bulwark-build");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> TORVA_WARRIOR = new PermanentAttributeKey<>(false, "torva-warrior");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> ANCESTRAL_MAGE = new PermanentAttributeKey<>(false, "ancestral-mage");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> CANNON_CAPACITY = new PermanentAttributeKey<>(false, "cannon-capacity");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> SPECIAL_SURPRISE = new PermanentAttributeKey<>(false, "special-surprise");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> TARNISHED_DAMAGE = new PermanentAttributeKey<>(false, "tarnished-damage");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> ADEQUATE_DAMAGE = new PermanentAttributeKey<>(false, "adequate-damage");

    /**
     * Battle Passes
     */
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BATTLEPASS_AUGUST_2023 = new PermanentAttributeKey<>(false, "battlepass-august-2023");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BATTLEPASS_FALL_2023 = new PermanentAttributeKey<>(false, "battlepass-fall-2023");

    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> BATTLEPASS_WINTER_2023 = new PermanentAttributeKey<>(false, "battlepass-winter-2023");
    ...
    @PermanentAttributeKeyComponent
    public static final PermanentAttributeKey<Boolean> HUNLLEF_WARNING = new PermanentAttributeKey<>(true, "toggleHunllefWarning");

    public int voteBossDamage;

    public int abominationDamage;

    public int corpDamage;

    public int avatarDamage;

    public int inadequacyDamage;

    public int brassicanDamage;
    ...
    public int[] runeEssencePouch = new int[4];
    public int[] pureEssencePouch = new int[4];
    ...
    public String toString() {
        return String.format("player[loginName=%s, displayName=%s, ip=%s, mac=%s, uuid=%s]", getLoginName(), getDisplayName(), getIpAddress(), getMacAddress(), getUUID());
    }
    ...
    public boolean hasRank(Right right) {
        return getRights().isOrInherits(right);
    }
    ...
    public Player(Channel channel) {
        ...
        playerEquipment[customslot1] = -1;
        playerEquipment[customslot2] = -1;
    ...
    public PlayerAddresses getValidAddresses() {
        ...
        if (getMacAddress() != null && getMacAddress().length() > 0 && !getMacAddress().equals(getIpAddress()))
            mac = getMacAddress();
        if (getUUID() != null && getUUID().length() > 0) uuid = getUUID();
    ...
    public boolean viewable(NPC npc, boolean updatingLocalList) {
        ...
        return withinDistance(npc) && !npc.isInvisible() && npc.getInstance() == getInstance() && !npc.needRespawn && npc.getIndex() > 0;
    }
    ...
    public boolean ignoreNewPlayerRestriction(Player other) {
        return getRights().ignoreNewPlayerRestriction() || other.getRights().ignoreNewPlayerRestriction() || getMode().isGroupIronman() || other.getMode().isGroupIronman();
    }
    ...
    public void setController(Controller controller) {
        if (this.controller != null) this.controller.removed(this);
        this.controller = controller;
        controller.added(this);
        if (!isBot()) logger.debug("Set controller to {}, {}", controller.getKey(), controller);
    }
    ...
    public boolean hasUnlockedGodSpell(int spell) {
        if (spell == 28) return saradominStrikeCasts >= 100;
        else if (spell == 29) return clawsOfGuthixCasts >= 100;
        else if (spell == 30) return flamesOfZamorakCasts >= 100;
        return true;
    }
    ...
    public void attemptLogout() {
        ...
        if (!isIdle && underAttackByNpc > 0 && underAttackByNpc != 2412 && underAttackByNpc != 2410 && underAttackByNpc != 2428) {
            sendMessage("You can\'t log out until 10 seconds after the end of combat.");
            sendMessage("Under attack by NPC: " + underAttackByNpc + ". Send to Bubly if an error.");
            return;
        }
        if (underAttackByPlayer > 0 && underAttackByNpc != 2412 && underAttackByNpc != 2410 && underAttackByNpc != 2428) {
            sendMessage("You can\'t log out until 10 seconds after the end of combat.");
            return;
        }
        ...
        if (!isDisconnected() && System.currentTimeMillis() - logoutDelay > 1000) {
            ...
            //HiscoresUpdateQuery updateQuery = new HiscoresUpdateQuery(this);
            //updateQuery.run();
        }
    }
    ...
    public boolean isReadyToLogout() {
        ...
        if (getLock().cannotLogout(this)) return false;
        return properLogout || isDisconnected() && System.currentTimeMillis() - logoutDelay > 10000 || isDisconnected() && disconnectTime != 0 && (System.currentTimeMillis() - disconnectTime >= 30000) || !bot && System.currentTimeMillis() - lastPacketReceived > 30000;
    }
    ...
    public void destruct() {
        ...
        try {
            ...
            new java.lang.Thread() {
                public void run() {
                    try {
                        com.everythingrs.hiscores.Hiscores.update("YglTT3Ab0TvHkc7ifW0bDemvAYouBquLpmUiLIhFs0ycB388WNrjlLcZhZvj72nq6V87Fehs", "Normal Mode", player.getDisplayName(), 0, player.playerXP, debugMessage);
                    } catch (Exception e) {
    ...
    public void leaderboardInitialize(Player player) {

        /**
         * Miscellanious
         */

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.tournamentWins, io.xeros.content.leaderboard.impl.Misc.TOURNAMENT_WINS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.tokensSpent, io.xeros.content.leaderboard.impl.Misc.DONATOR_TOKENS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.getEasyClueCounter(), io.xeros.content.leaderboard.impl.Misc.EASY_CLUES);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.getMediumClueCounter(), io.xeros.content.leaderboard.impl.Misc.MEDIUM_CLUES);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.getHardClueCounter(), io.xeros.content.leaderboard.impl.Misc.HARD_CLUES);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.MISCELLANEOUS, player.getMasterClueCounter(), io.xeros.content.leaderboard.impl.Misc.MASTER_CLUES);

        /**
         * Raids
         */

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.RAIDS, player.raidCount, Raid.CHAMBER_OF_XERIC);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.RAIDS, player.getNpcDeathTracker().getKc(NpcDef.forId(8360).getName()), Raid.THEATRE_OF_BLOOD);

        /**
         * Boss KC
         */

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(11278).getName()), Boss.NEX);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2042).getName()), Boss.ZULRAH);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(494).getName()), Boss.KRAKEN);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(8917).getName()), Boss.SEREN);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(10532).getName()), Boss.AVATAR_OF_DESTRUCTION);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(8195).getName()), Boss.BRYOPHYTA);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc("hunllef"), Boss.HUNLLEF);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(7416).getName()), Boss.OBOR);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2266).getName()), Boss.DAGANNOTH_PRIME);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2267).getName()), Boss.DAGANNOTH_REX);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2265).getName()), Boss.DAGANNOTH_SUPREME);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(5779).getName()), Boss.GIANT_MOLE);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6500).getName()), Boss.KALPHITE_QUEEN);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6766).getName()), Boss.LIZARDMAN_SHAMAN);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(8713).getName()), Boss.SARACHNIS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(499).getName()), Boss.THERMY);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(7144).getName()), Boss.DEMONIC_GORILLAS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2205).getName()), Boss.SARA_GWD);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(3129).getName()), Boss.ZAMMY_GWD);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2215).getName()), Boss.BANDOS_GWD);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(3162).getName()), Boss.ARMA_GWD);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(319).getName()), Boss.CORP);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(5862).getName()), Boss.CERBERUS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(5886).getName()), Boss.ABYSSAL_SIRE);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(8026).getName()), Boss.VORKATH);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(8615).getName()), Boss.HYDRA);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(9416).getName()), Boss.NIGHTMARE);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(7310).getName()), Boss.BRASSICAN);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(239).getName()), Boss.KBD);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6611).getName()), Boss.VETION);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6503).getName()), Boss.CALLISTO);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6615).getName()), Boss.SCORPIA);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6504).getName()), Boss.VENENATIS);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6619).getName()), Boss.CHAOS_FANATIC);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(6618).getName()), Boss.CRAZY_ARCHEOLOGIST);

        LeaderboardSerialisation.INSTANCE.updateCount(player, LeaderboardData.BOSSES, player.getNpcDeathTracker().getKc(NpcDef.forId(2054).getName()), Boss.CHAOS_ELEMENTAL);
    ...
    public void finishLogin() {
        ...
        if (PlayerHandler.updateRunning) getPA().sendUpdateTimer();

        // if (this.tokensSpent < 250) {
        //DonatorRank.addTokensSpent(this, 250);
        //}
        ...
        getPVPMysteryBox().canMysteryBox();
        getGodwarsMysteryBox().canMysteryBox();
        getRaresMysteryBox().canMysteryBox();
        getYoutubeMysteryBox().canMysteryBox();
        getFoeMysteryBox().canMysteryBox();
        getPetMysteryBox().canMysteryBox();
        ...
        //leaderboardInitialize(this);
        //System.out.println("ID: "+ this);

        if (votePoints > 0) {
            getInventory().addToBank(new ImmutableItem(Items.VOTE_CRYSTAL, votePoints));
            getDH().sendStatement("Vote points have been removed in favor of using vote crystals", "directly in the shop. You will no longer have to convert", "crystals to points. Your existing " + votePoints + " vote points have", "been converted to vote crystals and added to your bank.");
            votePoints = 0;
        }
        ...
        if (dropScrollTicks > 0) {
            getPA().sendGameTimer(ClientGameTimer.DROPS, TimeUnit.MINUTES, (int) (dropScrollTicks / 100));
        }
        if (combatLevel >= 126) {
        ...
        /*if (getMode().isIronmanType()) {
            ...
            orderedList.stream().filter(r -> tokensSpent >= r.amount).findFirst().ifPresent(rank -> {
        ...
        if (mageArena2Spawns == null) MageArenaII.assignSpawns(this);
        ...
        getItems().setEquipment(playerEquipment[customslot1], 1, customslot1, false);
        getItems().setEquipment(playerEquipment[customslot2], 1, customslot2, false);
        ...
        if (!completedTutorial) {
            ...
            if (Server.isDebug() && !bot) {
                ...
                getRights().add(Right.ONYX_DONATOR);
            ...
            Server.clanManager.getHelpClan().addMember(this);
            start(new TutorialDialogue(this));
    ...
    public void process() {
        ...
        if (!isCompletedTutorial() && (getDialogueBuilder() == null || getDialogueBuilder().getCurrent() == null) && !isInterfaceOpen(ModeSelection.INTERFACE_ID)) {
        ...
        if (trinketOfAdvancedTime > 0) {
            trinketOfAdvancedTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfAdvancedTime <= 0) {
                trinketOfAdvancedTime = 0;
                trinketOfAdvancedActive = false;
                sendMessage("@red@Your trinket of advanced weaponry is no longer active.");
            }
        }

        if (trinketOfUndeadTime > 0) {
            trinketOfUndeadTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfUndeadTime <= 0) {
                trinketOfUndeadTime = 0;
                trinketOfUndeadActive = false;
                sendMessage("@red@Your trinket of the undead is no longer active.");
            }
        }

        if (trinketOfExperienceTime > 0) {
            trinketOfExperienceTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfExperienceTime <= 0) {
                trinketOfExperienceTime = 0;
                trinketOfExperienceActive = false;
                sendMessage("@red@Your trinket of experience is no longer active.");
            }
        }

        if (trinketOfTricksTime > 0) {
            trinketOfTricksTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfTricksTime <= 0) {
                trinketOfTricksTime = 0;
                trinketOfTricksActive = false;
                sendMessage("@red@Your trinket of tricks is no longer active.");
            }
        }

        if (trinketOfNinjaTime > 0) {
            trinketOfNinjaTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfNinjaTime <= 0) {
                trinketOfNinjaTime = 0;
                trinketOfNinjaActive = false;
                sendMessage("@red@Your trinket of the ninja is no longer active.");
            }
        }

        if (trinketOfLuckTime > 0) {
            trinketOfLuckTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfLuckTime <= 0) {
                trinketOfLuckTime = 0;
                trinketOfLuckActive = false;
                sendMessage("@red@Your trinket of luck is no longer active.");
            }
        }

        if (trinketOfProtectionTime > 0) {
            trinketOfProtectionTime--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (trinketOfProtectionTime <= 0) {
                trinketOfProtectionTime = 0;
                trinketOfProtectionActive = false;
                sendMessage("@red@Your trinket of protection is no longer active.");
            }
        }
        ...
        if (dropScrollTicks > 0) {
            ...
            if (dropScrollTicks <= 0) {
                dropScrollTicks = 0;
                dropScrollActive = false;
                sendMessage("@red@Your drop rate scroll has run out!");
            }
        }
        if (doubleDropScrollTicks > 0) {
            doubleDropScrollTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (doubleDropScrollTicks <= 0) {
                doubleDropScrollTicks = 0;
                doubleDropScrollActive = false;
                sendMessage("@red@Your double drop scroll has run out!");
            }
        }
        if (seasonalScrollTicks > 0) {
            seasonalScrollTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (seasonalScrollTicks <= 0) {
                seasonalScrollTicks = 0;
                seasonalScrollActive = false;
                sendMessage("@red@Your double seasonal tickets scroll has run out!");
            }
        }
        if (fiftyDamageScrollTicks > 0) {
            fiftyDamageScrollTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (fiftyDamageScrollTicks <= 0) {
                fiftyDamageScrollTicks = 0;
                fiftyDamageScrollActive = false;
                sendMessage("@red@Your 50% damage boost scroll has run out.");
            }
        }
        if (tomeOfExperienceTicks > 0) {
            tomeOfExperienceTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (tomeOfExperienceTicks <= 0) {
                tomeOfExperienceTicks = 0;
                tomeOfExperienceActive = false;
                sendMessage("@red@Your tome of experience has run out.");
            }
        }

        if (tomeOfPetsTicks > 0) {
            tomeOfPetsTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (tomeOfPetsTicks <= 0) {
                tomeOfPetsTicks = 0;
                tomeOfPetsActive = false;
                sendMessage("@red@Your tome of pets has run out.");
            }
        }
        ...
        if (coxScrollTicks > 0) {
            ...
            if (coxScrollTicks <= 0) {
                coxScrollTicks = 0;
                coxScrollActive = false;
                sendMessage("@red@Your CoX boost scroll has run out!");
            }
        }
        if (damageScrollTicks > 0) {
            damageScrollTicks--;
            // sendMessage("You currently have " + dropScrollTicks + " ticks left for drop boost");
            if (damageScrollTicks <= 0) {
                damageScrollTicks = 0;
                damageScrollActive = false;
                sendMessage("@red@Your damage scroll has run out!");
            }
        }
        if (fasterCluesTicks > 0) {
            fasterCluesTicks--;
        ...
        if (System.currentTimeMillis() - specDelay > Configuration.INCREASE_SPECIAL_AMOUNT) {
            ...
            if (specAmount < 10) {
                ...
                if (this.hasPerk(Player.SPECIAL_SURPRISE) && !Boundary.isIn(this, Boundary.OUTLAST_AREA)) {
                    specAmount += 1;
                }

                if (this.getItems().isWearingItem(25975)) {
                    specAmount += 1;
                }
        ...
        if (this.skullTimer > 0) {
            if (!getItems().isWearingItem(Items.AMULET_OF_AVARICE)) {
                --skullTimer;
            }
            if (skullTimer == 1) {
                isSkulled = false;
    ...
    public void processCombat() {
        if (npcAttackingIndex > 0 && clickNpcType == 0 || playerAttackingIndex > 0) {
            ...
            if (getCombatItems().doQueuedGraniteMaulSpecials()) return;
        }
    ...
    public BonfireEvent getBonfire() {
        return bonfire;
    }
    ...
    public void queueMessage(Packet packet, boolean priority) {
        ...
        if (priority) priorityPackets.add(packet);
        else queuedPackets.add(packet);
    }
...
//        }
    ...
    public FlowerPokerHand getFlowerPoker() {
        if (flowerPokerHand == null) this.flowerPokerHand = new FlowerPokerHand(this);
    ...
    public boolean ancestralHat() {
        if (getItems().isWearingItem(21018) || getItems().isWearingItem(29000) || getItems().isWearingItem(29003) || getItems().isWearingItem(29006) || getItems().isWearingItem(29009)) {
            return true;
        }
        return false;
    }

    public boolean ancestralTop() {
        if (getItems().isWearingItem(21021) || getItems().isWearingItem(29001) || getItems().isWearingItem(29004) || getItems().isWearingItem(29007) || getItems().isWearingItem(29010)) {
            return true;
        }
        return false;
    }

    public boolean ancestralBottom() {
        if (getItems().isWearingItem(21024) || getItems().isWearingItem(29002) || getItems().isWearingItem(29005) || getItems().isWearingItem(29008) || getItems().isWearingItem(29011)) {
            return true;
        }
        return false;
    }

    public boolean torvaHelm(Player player) {
        if (getItems().isWearingItem(26382) || getItems().isWearingItem(29057) || getItems().isWearingItem(29060) || getItems().isWearingItem(29063) || getItems().isWearingItem(29066)) {
            return true;
        }
        return false;
    }

    public boolean torvaBody(Player player) {
        if (getItems().isWearingItem(26384) || getItems().isWearingItem(29058) || getItems().isWearingItem(29061) || getItems().isWearingItem(29064) || getItems().isWearingItem(29067)) {
            return true;
        }
        return false;
    }

    public boolean torvaLegs(Player player) {
        if (getItems().isWearingItem(26386) || getItems().isWearingItem(29059) || getItems().isWearingItem(29062) || getItems().isWearingItem(29065) || getItems().isWearingItem(29068)) {
            return true;
        }
        return false;
    }

    public boolean wearingFaerdhinenBow() {
        if (getItems().isWearingItem(25865) || getItems().isWearingItem(25867) || getItems().isWearingItem(25869) || getItems().isWearingItem(25888) || getItems().isWearingItem(25886)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean wearingCrystalHelm() {
        if (getItems().isWearingItem(23971) || getItems().isWearingItem(23842) || getItems().isWearingItem(29047) || getItems().isWearingItem(29050) || getItems().isWearingItem(29053)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean wearingCrystalBody() {
        if (getItems().isWearingItem(23975) || getItems().isWearingItem(23845) || getItems().isWearingItem(29048) || getItems().isWearingItem(29051) || getItems().isWearingItem(29054)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean wearingCrystalLegs() {
        if (getItems().isWearingItem(23979) || getItems().isWearingItem(23848) || getItems().isWearingItem(29049) || getItems().isWearingItem(29052) || getItems().isWearingItem(29055)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidRangeT2() {
        if (getItems().isWearingItem(11664) && getItems().isWearingItem(29026) && getItems().isWearingItem(29027) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidRangeT3() {
        if (getItems().isWearingItem(11664) && getItems().isWearingItem(29028) && getItems().isWearingItem(29029) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidRangeT4() {
        if (getItems().isWearingItem(11664) && getItems().isWearingItem(29030) && getItems().isWearingItem(29031) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidRangeT5() {
        if (getItems().isWearingItem(11664) && getItems().isWearingItem(29032) && getItems().isWearingItem(29033) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMeleeT2() {
        if (getItems().isWearingItem(11665) && getItems().isWearingItem(29026) && getItems().isWearingItem(29027) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMeleeT3() {
        if (getItems().isWearingItem(11665) && getItems().isWearingItem(29028) && getItems().isWearingItem(29029) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMeleeT4() {
        if (getItems().isWearingItem(11665) && getItems().isWearingItem(29030) && getItems().isWearingItem(29031) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMeleeT5() {
        if (getItems().isWearingItem(11665) && getItems().isWearingItem(29032) && getItems().isWearingItem(29033) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMagicT2() {
        if (getItems().isWearingItem(11663) && getItems().isWearingItem(29026) && getItems().isWearingItem(29027) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMagicT3() {
        if (getItems().isWearingItem(11663) && getItems().isWearingItem(29028) && getItems().isWearingItem(29029) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMagicT4() {
        if (getItems().isWearingItem(11663) && getItems().isWearingItem(29030) && getItems().isWearingItem(29031) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean fullVoidMagicT5() {
        if (getItems().isWearingItem(11663) && getItems().isWearingItem(29032) && getItems().isWearingItem(29033) && getItems().isWearingItem(8842)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean zenithNeck() {
        if (getItems().isWearingItem(23240) || getItems().isWearingItem(29036) || getItems().isWearingItem(29037) || getItems().isWearingItem(6200) || getItems().isWearingItem(6201)) {
            return true;
        } else {
            return false;
        }
    ...
    protected void appendPlayerAppearance(Stream str) {
        ...
        if (isNpc == false) {
            ...
            if (playerEquipment[customslot1] > 1) {
                appearanceUpdateBlockCache.writeUnsignedWord(512 + playerEquipment[customslot1]);
            } else { // 1sec
                appearanceUpdateBlockCache.writeByte(0);
            }
    ...
    public void setLevel(Skill skill, int experience, boolean clientUpdate) {
        ...
        if (clientUpdate) getPA().refreshSkill(skill.getId());
    }
    ...
    public void appendDamage(Entity entity, int damage, Hitmark h) {
        ...
        if (damage > 0 && getPermAttributes().getOrDefault(Player.BULWARK_BUILD) && !Boundary.isIn(this, Boundary.WILDERNESS) && !Boundary.isIn(this, Boundary.OUTLAST) && Misc.hasOneOutOf(2)) {
            damage = (int) (damage * 0.6) + 1;
        }

        if (damage > 0 && Misc.hasOneOutOf(5) && trinketOfProtectionActive) {
            sendMessage("Your trinket of protection shielded you from " + damage + " damage.");
            damage = 0;
        }

        if (this.getMode().getType() == ModeType.ROGUE_HARDCORE_IRONMAN || this.getMode().getType() == ModeType.ROGUE || this.getMode().getType() == ModeType.ROGUE_IRONMAN) {
            if (damage > 0 && !Boundary.isIn(this, Boundary.WILDERNESS) && !Boundary.isIn(this, Boundary.OUTLAST))
                damage = (int) (damage * 0.9) + 1;
        }
    ...
    public boolean dropScrollActive;
    public long dropScrollTicks;
    public boolean seasonalScrollActive;
    public long seasonalScrollTicks;
    public boolean damageScrollActive;
    public long damageScrollTicks;
    public boolean coxScrollActive;
    public long coxScrollTicks;
    public boolean fiftyDamageScrollActive;
    public long fiftyDamageScrollTicks;
    public boolean doubleDropScrollActive;
    public long doubleDropScrollTicks;
    public boolean tomeOfExperienceActive;
    public long tomeOfExperienceTicks;
    public boolean tomeOfPetsActive;
    public long tomeOfPetsTicks;
    ...
    public boolean trinketOfLuckActive;
    public long trinketOfLuckTime;
    public long trinketOfLuckCooldown;

    public boolean trinketOfProtectionActive;
    public long trinketOfProtectionTime;
    public long trinketOfProtectionCooldown;

    public boolean trinketOfNinjaActive;
    public long trinketOfNinjaTime;
    public long trinketOfNinjaCooldown;

    public boolean trinketOfSuperiorityActive;

    public String trinketOfTricksType;
    public String trinketOfTricksBoost;
    public boolean trinketOfTricksActive;
    public long trinketOfTricksTime;
    public long trinketOfTricksCooldown;

    public boolean trinketOfExperienceActive;

    public long trinketOfExperienceTime;

    public long trinketOfExperienceCooldown;

    public boolean trinketOfUndeadActive;

    public long trinketOfUndeadTime;

    public long trinketOfUndeadCooldown;

    public boolean trinketOfAdvancedActive;
    public long trinketOfAdvancedTime;
    public long trinketOfAdvancedCooldown;

    public long trinketOfRestorationCooldown;
    ...
    public PVPMysteryBox getPVPInterface() {
        return PVPMysteryBox;
    }

    public RaresMysteryBox getRaresInterface() {
        return RaresMysteryBox;
    }
    ...
    public PetMysteryBox getPetInterface() {
        return petMysteryBox;
    }
    ...
    public boolean hasMageArena2BossItem(int bossEnumId) {
        ...
        if (bossEnumId == 0) itemIdRequired = 21797;
        else if (bossEnumId == 1) itemIdRequired = 21798;
        else itemIdRequired = 21799;
    ...
    public PVPMysteryBox getPVPMysteryBox() {
        return PVPMysteryBox;
    }

    public GodwarsMysteryBox getGodwarsMysteryBox() {
        return GodwarsMysteryBox;
    }

    public RaresMysteryBox getRaresMysteryBox() {
        return RaresMysteryBox;
    }
    ...
    public void sendDestroyItem(int itemId) {
        ...
        if (!this.getItems().playerHasItem(itemId)) return;

        final String itemName = def.getName();

        this.start(new DialogueBuilder(this).option("Destroy " + itemName + "?", new DialogueOption("Yes", player -> {
    ...
    public void setRequiresPinUnlock(boolean requiresPinUnlock) {
        ...
        if (requiresPinUnlock) logger.debug("Requires account pin unlock.");
    }
    ...
    public LeaderboardPeriodicity getCurrentLeaderboardPeriod() {
        if (currentLeaderboardPeriod == null) return LeaderboardPeriodicity.TODAY;
