...
public class PetHandler {
    ...
    private static final ImmutableSet<Integer> PET_IDS = ImmutableSet.of(12650, 12649, 12651, 12652, 12644, 12645,
            12643, 11995, 15568, 12653, 12655, 13178, 12646, 13179, 13177, 12921, 13181, 12816, 12647, 24491, 26348, 23495,21748);
    ...
    public enum Pets {
        NEX(26348, 11276, "Nex", 500, "second"),
...
//        ANTI_SANTA_JR(9959, 1048, "Anti-Santa", 500,"first"),
        ...
        MIMIC(19942, 1089, "The Mimic", 200, "second"),
        RED_SEREN(23939, 1088, "Fragment of seren", 750, "second"),
        ...
        DARK_RED_SEREN(30123, 2310, "Fragment of seren", 2000, "second");
    ...
    public static void roll(Player player, Pets p) {
        ...
        if (random == 1 || player.hasPerk(Player.PET_CEMETARY) && random == 2) {
            ...
            PlayerHandler.dropMessage(player.getDisplayNameFormatted() + " has received a pet drop from " + p.parent + ".");
        }
    }
