...
public class FlowerPokerHand {
    ...
    public static List<Position> positions = Arrays.asList(
            new Position(3076, 3464, 0),
            new Position(3081, 3464, 0),
            new Position(3086, 3464, 0),
            new Position(3091, 3464, 0));
    ...
    public void pathToLane(boolean tieReplant) {
        ...
        CycleEventHandler.getSingleton().addEvent(FLOWER_OBJECT, new CycleEvent() {
            ...
            public void execute(CycleEventContainer exe) {
                ...
                if (isAtDestination()) {
                    player.forcedChat(""+player.getDisplayName() +" vs "+other.getDisplayName()+" ["+Misc.formatCoins(calculateGpPot())+" POT]");
                    currentForceText = "";
    ...
    public void handleRoll() {
        ...
        CycleEventHandler.getSingleton().addEvent(FLOWER_OBJECT, new CycleEvent() {
            ...
            public void execute(CycleEventContainer exe) {
                ...
                int forcePlantTicks = Server.isDebug() ? 15 : 15;
    ...
    private void updateFaceDirection() {
        ...
        player.facePosition(new Position(player.getX(), player.getY() - 1)); //controls the direction being faced after planting
            ...
            CycleEventHandler.getSingleton().addEvent(FLOWER_OBJECT, new CycleEvent() {
                ...
                public void execute(CycleEventContainer exe) {
                    ...
                    if (exe.getTotalExecutions() == 5) {
                        ...
                        if (!player.getItems().playerHasItem(300)) {
                            player.getItems().addItem(299, 5);
                        }
                        if (!other.getItems().playerHasItem(300)) {
    ...
    public void plantSeed(Player person, boolean manualClick, boolean forced) {
        ...
        if (person.getItems().playerHasItem(299)) {
