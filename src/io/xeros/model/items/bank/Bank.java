...
public class Bank {
	...
	public int getBankCapacity() {
		int bonusSpaces = 0;
		if (player.hasPerk(Player.BANK_HOARDER)) {
			bonusSpaces = 500;
		}
		bonusSpaces += player.extraBankSpace;
		return Configuration.BANK_CAPACITY + bonusSpaces + (int) (Right.DONATOR_SET.stream().filter(
