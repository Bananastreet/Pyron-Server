...
public enum Mineral {
			...
			AFK_ROCK(new int[] { 2816 }, "none", 1, 1, -1, -1, 15, 30000, false, generateExclusive(7774)),
			...
			SHOOTING_STAR(new int[] { 41020, 41021, 41223, 41224, 41227 }, "none", 1, 18, -1, -1, 29, 15000, false, generateExclusive(Items.STARDUST)),
