...
public class Yell extends Command {
	...
	private static final Right[] PERMITTED = { Right.SAPPHIRE_DONATOR, Right.EMERALD_DONATOR, Right.RUBY_DONATOR, Right.DIAMOND_DONATOR,
												Right.ONYX_DONATOR, Right.HELPER, Right.MODERATOR, Right.ADMINISTRATOR,
	...
	public void execute(Player player, String commandName, String input) {
		...
		String message = formatMessage("@red@[YELL] "+player.getTitles().getCurrentTitle(),
	...
	private long getDelay(Player player) {
		return DonatorRank.getYellTimer(DonatorRank.getHighestRank(player));
	}
