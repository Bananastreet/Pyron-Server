...
public class TarnNPC extends NPC {

    public static void checkRequirements(Player player) {

    }

    public TarnNPC(int npcId, Position position, Player player) {
    ...
    private void greenBurst(Player victim, TarnNPC tarn) {
    ...
    private void undergroundFire(Player victim, TarnNPC tarn) {
        CycleEventHandler.getSingleton().addEvent(new Object(), new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
    ...
    private void smokescreen(Player victim, TarnNPC tarn) {
        CycleEventHandler.getSingleton().addEvent(new Object(), new CycleEvent() {
            @Override
            public void execute(CycleEventContainer container) {
