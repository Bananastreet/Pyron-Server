...
public class Skotizo extends LegacySoloPlayerInstance {
	 ...
	 */
	private static final int START_X = 2267, START_Y = 5663;
	
	/**
	 * Npc variables, start coordinates.
	 */
	public static final int SPAWN_X = 2279,
			SPAWN_Y = 5664,
			SKOTIZO_ID = 7286,
			...
			while (!unique) {
				...
				if(altar == null) {
					...
					if (ALTAR_MAP_DIRECTION[altarNumber-1] == "NORTH") {
						...
						Server.getGlobalObjects().remove(28924, 2270, 5677, getHeight(), this); // Remove North - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2270, 5677, getHeight(), 2, 10, -1, -1).setInstance(this)); // North - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_NORTH, 2270, 5677, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						northAltar = true;
						...
						Server.getGlobalObjects().remove(28924, 2272, 5651, getHeight(), this); // Remove South - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2272, 5651, getHeight(), 0, 10, -1, -1).setInstance(this)); // South - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_SOUTH, 2272, 5651, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						southAltar = true;
						...
						Server.getGlobalObjects().remove(28924, 2257, 5663, getHeight(), this); // Remove West - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2257, 5663, getHeight(), 1, 10, -1, -1).setInstance(this)); // West - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_WEST, 2257, 5663, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						westAltar = true;
						...
						Server.getGlobalObjects().remove(28924, 2286, 5664, getHeight(), this); // Remove East - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2286, 5664, getHeight(), 3, 10, -1, -1).setInstance(this)); // East - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_EAST, 2286, 5664, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						eastAltar = true;
					}
				} else {
	...
	public void init() {
		...
		Server.getGlobalObjects().add(new GlobalObject(28924, 2272, 5651, getHeight(), 0, 10, -1, -1).setInstance(this)); // South - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2270, 5677, getHeight(), 2, 10, -1, -1).setInstance(this)); // North - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2257, 5663, getHeight(), 1, 10, -1, -1).setInstance(this)); // West - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2286, 5664, getHeight(), 3, 10, -1, -1).setInstance(this)); // East - Empty Altar
	}
