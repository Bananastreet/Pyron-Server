...
public enum Title implements Comparator<Title> {
	...
	CUSTOM("Custom", 0, TitleCurrency.NONE, new TitleRequirement() {
		...
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.RUBY_DONATOR) || player.getRights().isOrInherits(Right.DIAMOND_DONATOR) || player.getRights().isOrInherits(Right.ONYX_DONATOR) || player.getRights().isOrInherits(Right.MODERATOR);
		}
	...
	REGULAR_DONATOR("Donator", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.SAPPHIRE_DONATOR);
		}
	...
	EXTREME_DONOR("Extreme", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.EMERALD_DONATOR);
		}
	...
	DIAMOND_CLUB("Diamond Club", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.DIAMOND_DONATOR);
		}
	...
	ONYX_CLUB("Onyx Club", 0, TitleCurrency.NONE, new TitleRequirement() {
		@Override
		public boolean meetsStandard(Player player) {
			return player.getRights().isOrInherits(Right.ONYX_DONATOR);
		}
