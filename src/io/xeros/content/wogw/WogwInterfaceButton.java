...
public enum WogwInterfaceButton {
    EXPERIENCE_BOOST(22943, 22946, Wogw.EXPERIENCE_COINS_REQUIRED),
    PEST_CONTROL_BOOST(22947, 22950, Wogw.PC_COINS_REQUIRED),
    DROP_RATE_BOOST(22951, 22954, Wogw.DROP_RATE_COINS_REQUIRED);
