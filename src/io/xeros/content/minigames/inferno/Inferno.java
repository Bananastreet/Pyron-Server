...
public class Inferno extends Tzkalzuk {
    ...
    public static void gamble(Player player) {
        ...
        if (Misc.random(25) == 0) {
            PlayerHandler.dropMessage(player.getDisplayNameFormatted() + " received a pet from TzKal-Zuk!");
    ...
    public final void end(DisposeTypes dispose) {
        ...
        if (dispose == DisposeTypes.COMPLETE) {
            ...
            PlayerHandler.executeGlobalMessage("@cr10@@red@" + player.getDisplayName() + " has successfully defeated the Inferno. Congratulations!");
