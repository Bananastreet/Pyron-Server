...
public class MeleeData {
	...
	public static boolean usingSytheOfVitur(Player player) {
		return player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(Items.SCYTHE_OF_VITUR) || player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29070) || player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29071) || player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29072) || player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29073);
	}
	...
	public static void setWeaponAnimations(Player c) {
		...
		if (weaponName.contains("wand") || weaponName.contains("staff") || weaponId == 27275 || weaponName.contains("trident")) {
			c.playerStandIndex = 809;
			c.playerRunIndex = 1210;
			c.playerWalkIndex = 1146;
			return;
	...
	public static int getWepAnim(Player c) {
		...
		if (weaponName.contains("ghrazi rapier") || weaponName.contains("rapier") || weaponName.contains("osmumten")) {
			return 8145;
		}
		if (weaponName.contains("zamorakian")) {
			return 2080;
