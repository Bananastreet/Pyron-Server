...
public class ScytheOfVitur implements SpecialEffect {
    ...
    public static boolean usingScythe(Player player) {
        return player.getItems().isWearingItem(Items.SCYTHE_OF_VITUR, Player.playerWeapon) || player.getItems().isWearingItem(29070, Player.playerWeapon) || player.getItems().isWearingItem(29071, Player.playerWeapon) || player.getItems().isWearingItem(29072, Player.playerWeapon) || player.getItems().isWearingItem(29073, Player.playerWeapon);
    }

    @Override
    public boolean activateSpecialEffect(Player player, Object... args) {
        boolean usingScythe = usingScythe(player);
