...
public class CombatItems {
	...
	public boolean elyProc() {
		if (c.playerEquipment[Player.playerShield] == 12817 && Misc.trueRand(10) <= 6
				|| c.playerEquipment[Player.playerShield] == 29035 && Misc.trueRand(10) <= 7
				|| c.playerEquipment[Player.playerShield] == 3711 && Misc.trueRand(10) <= 7
				|| c.playerEquipment[Player.playerShield] == 3712 && Misc.trueRand(10) <= 7
				|| c.playerEquipment[Player.playerShield] == 3713 && Misc.trueRand(10) <= 7) {
	...
	public boolean usingFaerdhinen() {
