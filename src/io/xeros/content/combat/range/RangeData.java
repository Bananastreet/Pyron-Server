...
public class RangeData {
	...
	public static final int[] karilsbows = {4734, 4934, 4935, 4936, 4937, 4938};
    public static final int[] BOWS = { 19481, 19478, 12788, 9185, 11785, 21012, 839, 845, 847, 851, 855, 859, 841, 843, 849,
            ...
            4221, 4222, 4223, 4734, 6724, 20997, 21902, 22550, 3694, 3714, 3715, 3716, Items.BOW_OF_FAERDHINEN, Items.BOW_OF_FAERDHINEN_T2, Items.BOW_OF_FAERDHINEN_T3, Items.BOW_OF_FAERDHINEN_T4, Items.BOW_OF_FAERDHINEN_T5 };
    ...
    public static final int[] NO_ARROW_DROP = { 11959, 10033, 10034, 4212, 22550, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221,
            4222, 4223, 4734, 4934, 4935, 4936, 4937, 22550, Items.BOW_OF_FAERDHINEN, Items.BOW_OF_FAERDHINEN_T2, Items.BOW_OF_FAERDHINEN_T3, Items.BOW_OF_FAERDHINEN_T4, Items.BOW_OF_FAERDHINEN_T5 };
...
//
				...
				//Bow of Faerdhinen
				{ Items.BOW_OF_FAERDHINEN, 1888 },
				{ Items.BOW_OF_FAERDHINEN_T2, 1923 },
				{ Items.BOW_OF_FAERDHINEN_T3, 1935 },
				{ Items.BOW_OF_FAERDHINEN_T4, 1929 },
				{ Items.BOW_OF_FAERDHINEN_T5, 1927 },

				// ARROWS
				{ 882, 19 }, { 884, 18 }, { 886, 20 }, { 888, 21 }, { 890, 22 }, { 892, 24 }, { 11212, 1116 }, { 21326, 1385 },
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		int[][] data = {
				...
				//bow of faerdhinen
				{ Items.BOW_OF_FAERDHINEN, 1887},
				{ Items.BOW_OF_FAERDHINEN_T2, 1922 },
				{ Items.BOW_OF_FAERDHINEN_T3, 1934 },
				{ Items.BOW_OF_FAERDHINEN_T4, 1928 },
				{ Items.BOW_OF_FAERDHINEN_T5, 1926 },
