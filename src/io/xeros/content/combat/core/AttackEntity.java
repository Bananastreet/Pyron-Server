...
public class AttackEntity {
    ...
    public int getAttackDelay() {
       ...
       // if (attacker.getDisplayName().equalsIgnoreCase("bubly")) {
           // attackSpeed -= 2;
       // }
        if (attacker.trinketOfNinjaActive && attackSpeed == 5) {
            //attacker.sendMessage("The trinket of ninja makes you attack faster.");
            return 4;
        }
        if (attacker.trinketOfNinjaActive && attackSpeed == 6) {
            //attacker.sendMessage("The trinket of ninja makes you attack faster.");
            return 5;
        }
        if (attacker.trinketOfNinjaActive && attackSpeed == 7) {
            //attacker.sendMessage("The trinket of ninja makes you attack faster.");
            return 6;
        }
        if (attacker.trinketOfNinjaActive && attackSpeed == 8) {
            //attacker.sendMessage("The trinket of ninja makes you attack faster.");
            return 7;
        }
    ...
    public void attackEntity(Entity targetEntity) {
        ...
        if (targetEntity.isNPC() && !attacker.usingClickCast) {
            ...
            if (attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF || attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF_T2 || attacker.playerEquipment[Player.playerWeapon] == 29043 || attacker.playerEquipment[Player.playerWeapon] == 29044 || attacker.playerEquipment[Player.playerWeapon] == 29045) {
                attacker.usingMagic = true;
                attacker.autocasting = true;
    ...
    private void handleItemChangesOnAttack(Entity targetEntity) {
        ...
        if (!attacker.usingMagic) {
            ...
            if (targetEntity.isNPC()) {
                ...
                } else if (attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF || attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF_T2 || attacker.playerEquipment[Player.playerWeapon] == 29043 || attacker.playerEquipment[Player.playerWeapon] == 29044 || attacker.playerEquipment[Player.playerWeapon] == 29045) {
    ...
    private boolean determineWeaponStyle() {
        ...
        switch (attacker.playerEquipment[Player.playerWeapon]) {
            ...
            case 29045:
                ...
                return true;
            case Items.SANGUINESTI_STAFF_T2:
                if (!attacker.usingClickCast) {
                    attacker.usingMagic = true;
                    attacker.autocasting = true;
                    attacker.autocastId = SanguinestiStaff.COMBAT_SPELL_INDEX;
        ...
        if (!attacker.usingMagic) {
            ...
            if (!attacker.usingBallista && !attacker.usingCross && !attacker.usingArrows && attacker.usingBow && (((attacker.playerEquipment[Player.playerWeapon] < 4212) || (attacker.playerEquipment[Player.playerWeapon] > 4223)))
                ...
                if (attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T2 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T3 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T4 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T5) {
            ...
            if (!Bow.canUseArrow(attacker) && Configuration.CORRECT_ARROWS && attacker.usingBow && !attacker.getCombatItems().usingCrystalBow() && !(attacker.playerEquipment[Player.playerWeapon] == 22550) && attacker.playerEquipment[Player.playerWeapon] != 9185
                    && attacker.playerEquipment[Player.playerWeapon] != 4734 && attacker.playerEquipment[Player.playerWeapon] != 11785 && attacker.playerEquipment[Player.playerWeapon] != 21012
                    && attacker.playerEquipment[Player.playerWeapon] != 12926 && attacker.playerEquipment[Player.playerWeapon] != 19478
                    && attacker.playerEquipment[Player.playerWeapon] != 19481 && attacker.playerEquipment[Player.playerWeapon] != 21902
            && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T2 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T3 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T4 && attacker.playerEquipment[Player.playerWeapon] != Items.BOW_OF_FAERDHINEN_T5) {
