                ...
                case MAGE:
                    ...
                    if (damage.isSuccess()) {
                        ...
                        if (attacker.oldSpellId > -1) {
                            ...
                            if (attacker.getSpellId() == SanguinestiStaff.COMBAT_SPELL_INDEX && Misc.trueRand(6) == 0 && attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF) {
                                attacker.getHealth().increase(damage.getAmount() / 2);
                                attacker.startGraphic(new Graphic(1542));
                            }
                            if (attacker.getSpellId() == SanguinestiStaff.COMBAT_SPELL_INDEX && Misc.trueRand(4) == 0 && attacker.playerEquipment[Player.playerWeapon] == Items.SANGUINESTI_STAFF_T2) {
                                attacker.getHealth().increase(damage.getAmount() / 2);
                                attacker.startGraphic(new Graphic(1542));
                            }
                            if (attacker.getSpellId() == SanguinestiStaff.COMBAT_SPELL_INDEX && Misc.trueRand(4) == 0 && attacker.playerEquipment[Player.playerWeapon] == 29043) {
                                attacker.getHealth().increase(damage.getAmount() / 2);
                                attacker.startGraphic(new Graphic(1542));
                            }
                            if (attacker.getSpellId() == SanguinestiStaff.COMBAT_SPELL_INDEX && Misc.trueRand(4) == 0 && attacker.playerEquipment[Player.playerWeapon] == 29044) {
                                attacker.getHealth().increase(damage.getAmount() / 2);
                                attacker.startGraphic(new Graphic(1542));
                            }
                            if (attacker.getSpellId() == SanguinestiStaff.COMBAT_SPELL_INDEX && Misc.trueRand(4) == 0 && attacker.playerEquipment[Player.playerWeapon] == 29045) {
                                attacker.getHealth().increase(damage.getAmount() / 2);
                                attacker.startGraphic(new Graphic(1542));
                            }
                        }
