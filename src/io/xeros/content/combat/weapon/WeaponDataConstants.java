...
public class WeaponDataConstants {
    ...
    public static final int[] SPEARS = {
            ...
            Items.VESTAS_SPEAR, Items.ANGER_SPEAR, Items.BONE_SPEAR, Items.LEAF_BLADED_SPEAR, Items.GUTHANS_WARSPEAR, Items.ZAMORAKIAN_SPEAR, Items.DRAGON_HUNTER_LANCE, 29075,
    ...
    public static final int[] SCYTHE = {
            Items.SCYTHE, Items.SCYTHE_OF_VITUR, 29070, 29071, 29072, 29073
    };
    ...
    public static final int[] STAB_SWORDS = {
            ...
            Items.ANGER_SWORD, Items.TRAINING_SWORD, Items.WOODEN_SWORD, Items.SPORK, Items.RAPIER, Items.GHRAZI_RAPIER, 3692, 29013, 29014, 29015, Items.TOKTZ_XIL_AK, Items.LEAF_BLADED_SWORD,
    ...
    public static final int[] WHIPS = {
            ...
            Items.ABYSSAL_TENTACLE_OR, Items.ABYSSAL_WHIP_OR,
    ...
    public static final int[] STANDARD_STAFFS = {
            ...
            Items.TRIDENT_OF_THE_SEAS, Items.TRIDENT_OF_THE_SWAMP, Items.SANGUINESTI_STAFF, Items.DAWNBRINGER, Items.STAFF_OF_LIGHT, Items.SANGUINESTI_STAFF_T2, 29043, 29044, 29045, 27275,
    ...
    public static final int[] BOWS = {
            ...
            //Special Bows
            Items.CURSED_GOBLIN_BOW, Items.TRAINING_BOW, Items.OGRE_BOW, Items.DARK_BOW, Items.CRYSTAL_BOW, Items.TWISTED_BOW, Items.CRAWS_BOW, 3714, 3715, 3716,
            Items.DARK_BOW_BLUE, Items.DARK_BOW_GREEN,Items.DARK_BOW_YELLOW,Items.DARK_BOW_WHITE, Items.THIRD_AGE_BOW, Items.CORRUPT_TWISTED_BOW, Items.BOW_OF_FAERDHINEN, Items.BOW_OF_FAERDHINEN_T2, Items.BOW_OF_FAERDHINEN_T3, Items.BOW_OF_FAERDHINEN_T4, Items.BOW_OF_FAERDHINEN_T5,
