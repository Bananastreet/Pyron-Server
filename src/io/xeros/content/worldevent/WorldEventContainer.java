...
import io.xeros.content.worldevent.impl.BossSpotlightWorldEvent;
...
public class WorldEventContainer {
    ...
    public static final List<WorldEvent> WORLD_EVENT_LIST = Collections.unmodifiableList(
            Lists.newArrayList(new TournamentWorldEvent(), new ShootingStarWorldEvent(),
                    new BossSpotlightWorldEvent()
                    /*new HesporiWorldEvent(), new WildernessBossWorldEvent()*/));
