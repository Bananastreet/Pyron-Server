...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the Pyron Guide");
            ...
            case 7:
                ...
                lines.add("the guide says you can teleport there if you use the teleport platform and then go to learning the ropes");
            ...
            if (option == 1) {
                if (getStage() == 0) {
                                            ...
                                            player.start(getXerosGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getXerosGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time on Pyron.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM_TALK, "Use the teleport platform to open ", "the teleport menu. Then go to 'Learning The Ropes'.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM_TALK, "Use any teleport in your spellbook to open ", "the teleport menu. Then go to 'Learning The Ropes'.")
                            .npc(DialogueExpression.CALM_TALK, "Once you kill the hobgoblin and get my sword", "come back and show me it.")
                            .exit(plr -> {
                                plr.getPA().closeAllWindows();
                            }));
                    ...
                    player.start(getXerosGuide()
                            ...
                            .player("Interesting.")
                            .npc(DialogueExpression.CALM_TALK, "if you do ::foe you can burn the sword", "burn my sword and report back to me")
                            .exit(plr -> {
                                incrementStage();
                                plr.getPA().closeAllWindows();
                            }));
        ...
        if (Boundary.SKILLING_ISLAND.in(player) && npc.getNpcId() == Npcs.HOBGOBLIN_2) {
            if (getStage() >= 7 && getStage() <=9){
                Server.itemHandler.createGroundItem(player, 22316, npc.getX(), npc.getY(), player.getHeight(), 1, player.getIndex());
                 if (getStage() == 7) {
                    player.start(new DialogueBuilder(player).player("I think the hobgoblin dropped a sword", "I should give the sword back to the guide"));
                    incrementStage();
                }
            }
        }
